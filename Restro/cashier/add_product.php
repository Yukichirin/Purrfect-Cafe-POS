...
if (isset($_POST['addProduct'])) {
  ...
  if (empty($_POST["prod_barcode"]) || empty($_POST["prod_name"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price'])) {
    ...
    $postQuery = "INSERT INTO rpos_products (prod_id, prod_barcode, prod_name, prod_img, prod_desc, prod_price ) VALUES(?,?,?,?,?,?)";
    $postStmt = $mysqli->prepare($postQuery);
    //bind parameters
    $rc = $postStmt->bind_param('ssssss', $prod_id, $prod_barcode, $prod_name, $prod_img, $prod_desc, $prod_price);
    $postStmt->execute();
